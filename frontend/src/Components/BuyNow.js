      ...
      <div className="container mx-auto p-4  md:flex gap-4 ">
          ...
          <div className="h-200px lg:flex gap-4 ">
            <div className="flex gap-2  lg:flex-col overflow-y-scroll  scrollbar-none h-[100px] lg:h-[400px]">
              {data?.productImage?.map((imageURL, index) => {
                return (
                  <div
                    className="h-24 w-24 bg-slate-200 rounded"
                    key={imageURL}
                  >
                    <img
                      src={imageURL}
            ...
            <div className=" relative  h-96 w-96 lg:h-[500px] lg:w-[500px] rounded   bg-slate-200">
              <img
                src={activeImage}
                className="object-sacle-down mix-blend-multiply h-full w-auto "
        ...
        {loading ? (
          <div className="p-4  w-80 flex-col">
            ...
            <div className="flex gap-2  bg-slate-200 h-6 m-2 w-full  animate-pulse"></div>

            <div className=" py-4  ">
              <p
                style={{ color: "#1b9430" }}
                className="bg-slate-200 h-6 m-2 w-full  animate-pulse"
              ></p>
              <div className="text-2xl grid md:flex gap-3">
            ...
            <div>
              <p className="bg-slate-200 h-6 m-2 w-full  animate-pulse  my-2">
                {" "}
              </p>
              <p className="bg-slate-200 h-6 m-2 w-full  animate-pulse"></p>
            </div>
          ...
          <div className="p-4 flex-col">
            ...
            <h2 className="text-semibold text-3xl  lg:text-4xl py-2">
              {data?.productName}
            </h2>
            ...
            <div className=" py-4  ">
              <p style={{ color: "#1b9430" }} className="text-xl">
                Special price
              </p>
              <div className="text-2xl grid md:flex gap-3">
                ...
                <p
                  style={{ color: "#ff2d55" }}
                  className="text-slate-500 line-through text-ellipsis line-clamp-1"
                >
            ...
            <div className="flex gap-3">
              {/* Add to cart and buy */}
              <button
                style={{ backgroundColor: "rgb(239 142 56)" }}
                className=" hover:bg-red-700 text-white px-3 py-1 rounded-full"
              >
                Add to Cart
              </button>
              <button
                style={{ backgroundColor: "rgb(236 88 9)" }}
                className=" hover:bg-red-700 text-white px-3 py-1 rounded-full"
              >
                Buy Now
              </button>
